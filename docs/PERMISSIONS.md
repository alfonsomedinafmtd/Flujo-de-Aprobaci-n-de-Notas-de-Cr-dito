...
| Ver analítica consolidada | Sí, alcance global | No | No |
...
8. La analítica se autoriza en el backend y mantiene separados los totales de USD y VES.
9. La nota conserva el cargo del solicitante al momento de creación como instantánea histórica.
