...
| Auditoría de quién hizo cada acción | Evento append-only con actor, rol, transición, comentario y fecha | `credit_note_events`, detalle visual y pruebas del historial |
