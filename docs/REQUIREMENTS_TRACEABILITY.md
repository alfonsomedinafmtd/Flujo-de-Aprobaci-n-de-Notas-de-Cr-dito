...
| Registro del uso de IA | Nueve prompts principales; decisiones aceptadas, modificadas y rechazadas; tres errores detectados y guía de defensa en vivo | `docs/AI_USAGE.md` |
